...
def main():
    ...
    cgpa = st.number_input('Enter CGPA till your previous semester:', min_value=0.1, step=0.1, value=0.0)
    credits = st.number_input('Enter the total credits earned till your previous semester:', min_value=1, step=1, value=0)
    curr_gpa = st.number_input('Enter GPA of your current semester:', min_value=0.1, step=0.1, value=0.0)
    curr_credits = st.number_input('Enter credits earned in the current semester:', min_value=1, step=1, value=0)
